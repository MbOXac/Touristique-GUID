...
class MockDataService {
  static List<GalleryItem> getGalleryItems() => List.of(const [
  ...
  static List<TopRatedPlace> getTopRatedPlaces() => List.of(const [
  ...
  static List<TripMemory> getTripMemories() => List.of(const [
  ...
  static List<Booking> getBookings() => List.of(const [
